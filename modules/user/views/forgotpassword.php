    ...
    <div class="page-content logopage">
		...
		<?php 
			...
			<div class="account text-center">
						...
						<div class="span"><a href="<?php echo site_url(); ?>home/login"><img src="<?php echo theme_url();?>img/facebook.png" alt=""><i>Sign In with Facebook</i><div class="clear"></div></a></div>	
						<div class="span1"><a href="#"><img src="<?php echo theme_url();?>img/twitter.png" alt=""><i>Sign In with Twitter</i><div class="clear"></div></a></div>
						<div class="span2"><a href="<?php echo base_url();?>home/googleLoginSubmit"><img src="<?php echo theme_url();?>img/gplus.png" alt=""><i>Sign In with Google+</i><div class="clear"></div></a></div>
					</div>
					</div>
