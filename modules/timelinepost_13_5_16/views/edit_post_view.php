...
<div class=" rightNameDetail col-md-12	 col-sm-12 col-xs-12"> <h4> <?php echo $userData[0]->first_name ;?> <?php echo $userData[0]->last_name ;?> </h4>
 ...
 <div class="details2"><i class="fa fa-map-marker"></i>Lives In: <?php echo $userData[0]->country_name ;?></div>
	  <div class="details2"><i class="fa fa-building-o"></i>From: <?php echo $userData[0]->city ;?> </div>
   ...
   {?>
	   <div class="details2"><i class="fa fa-phone-square"></i><?php echo $userData[0]->mobile ;?></div>
		<?php } else 
			{ ?>
		<div class="details2"><i class="fa fa-phone-square"></i>Not Provided</div>
		<?php } ?>
		<?php if($total_products>=1)
		{?>
	  <div class="details2"><i class="fa fa-bars"></i><a href="<?php echo base_url();?>timelinepost/more_products_user">Show all Products
		 </a></div>
		 <?php } ?>
</div>
