				...
				<?php if($userData[0]['profile_image'] !='')
					...
					<div class="partnerInfo">
						...
						<a href="<?php echo base_url();?>home/timelinepost/<?php echo $pageVal['user_id']; ?>"><?php echo $name ; ?></a>
							Is Traveling From 
								<?php
								$from = $pageVal['travel_from']; 
								echo $from;
								?>
						To
							<?php
							echo $from = $pageVal['travel_to'];
							 ?></div>
    ...
    $('#datetimepicker').datepicker({
       ...
       <script type="text/javascript">
        google.maps.event.addDomListener(window, 'load', function () {
            var places = new google.maps.places.Autocomplete(document.getElementById('travelFrom'));
      ...
      <script type="text/javascript">
        google.maps.event.addDomListener(window, 'load', function () {
            var places = new google.maps.places.Autocomplete(document.getElementById('travelTo'));
            google.maps.event.addListener(places, 'place_changed', function () {
                var place = places.getPlace();
                var address = place.formatted_address;
              //  var latitude = place.geometry.location.lat();
